...
class TestLayoutAutoDryRun:
    def test_auto_requires_pbip(self, runner):
        result = _run(runner, "layout", "auto",
                      "--pbip", "nonexistent.pbip", "--page", "Page1")
